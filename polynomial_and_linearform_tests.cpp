...
TEST(test_linear_form_addition) {
    ...
    ASSERT_EQ(res.CoefficientCount(), 3);
...
TEST(test_linear_form_subtraction) {
    ...
    ASSERT_EQ(self_diff.CoefficientCount(), 3);
...
TEST(test_linear_form_multiply_scalar) {
    ...
    ASSERT_EQ(zeroed.CoefficientCount(), 0);
...
TEST(test_linear_form_map_reduce_where) {
    ...
    ASSERT_EQ(filtered.CoefficientCount(), 4);
...
TEST(test_linear_form_with_complex) {
    ...
    ASSERT_EQ(lf.CoefficientCount(), 3);
...
TEST(test_linear_form_edge_cases) {
    ...
    ASSERT_EQ(added.CoefficientCount(), 1);
